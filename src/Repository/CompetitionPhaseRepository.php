...
class CompetitionPhaseRepository extends ServiceEntityRepository implements CompetitionPhaseRepositoryInterface
{
    ...
    {
        parent::__construct($registry, CompetitionPhase::class);
    }

//    /**
//     * @return CompetitionPhase[] Returns an array of CompetitionPhase objects
//     */
...
//    public function findOneBySomeField($value): ?CompetitionPhase
//    {
//        return $this->createQueryBuilder('c')
//            ->andWhere('c.exampleField = :val')
//            ->setParameter('val', $value)
